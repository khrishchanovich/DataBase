...
1. Вставка значений в таблицу InsuranceType
...
1. Использование логического оператора AND
...
1. Выборка уникальных данных из столбцов
...
1. Задается регулярное выражение (строка должна содержать …)
